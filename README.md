...
Для Yandex Cloud подготовлен Docker-сценарий запуска через виртуальную машину Compute Cloud.

Основной файл:

- `docker-compose.yml` — сборка контейнера, проброс порта `80`, хранение SQLite-базы в Docker volume.

Подробная инструкция:

- `docs/yandex_cloud_deploy.md`
