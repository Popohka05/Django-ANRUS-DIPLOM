...
При старте Amvera выполнит скрипт `deploy/amvera_start.sh`: соберет статические файлы, применит миграции, загрузит демо-словарь и запустит Django через Gunicorn.
